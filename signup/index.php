...
<body>
    ...
    <main>
        <div id="feed">
            ...
            <div id="signUp">
                ...
                <form id="signupForm" method="post" action="/signup/signup.php">
                    <div id="inviteCode">
                        ...
                        <div id="inputSignup">
                            ...
                            <button type="button" class="followButton" onclick="showNextSection('nameUser')">Next</button>
                        </div>
                    </div>
                    <div id="nameUser">
                        <p class="subText">Great! Now Chirpie just needs to get to know you and he'll set up your
                            ...
                            <div id="inputSignup">
                                ...
                                <button type="button" class="followButton" onclick="showNextSection('pwordUser')">Next</button>
                            </div>
                    </div>
                    <div id="pwordUser">
                        ...
                        <div id="inputSignup">
                            ...
                            <input type="password" id="pwordConfirm" name="pwordConfirm" placeholder="Confirm password" required>
                            </div>
                ...
                <div id="errors">
                    <p id="invalidCodeError">Invalid invite code</p>
                    <p id="usernameTakenError">Username already in use</p>
    ...
    .then(data => {
        if (data.error) {
            ...
            window.location.href = '/signup-success.html'; // Example redirect
        }
    })
