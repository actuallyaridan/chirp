            ...
            <?php else: ?>
                ...
                <div id="posts" data-offset="0" data-user-id="<?php echo htmlspecialchars($user['id']); ?>">
                    ...
                    <div class="noFoundUserTab">
                        <p>@<?php echo htmlspecialchars($user['username']); ?> hasn't chirped any media yet.</p>
                        <p class="subText">When they do, they'll show up here</p>
                    </div>
                </div>
                <!--<div id="noMoreChirps">
                <div class="lds-ring">
